...
CREATE TABLE `userData` (
  ...
  `numCompletedReservations` INT NOT NULL DEFAULT 0,
  `numActiveReservations` INT NOT NULL DEFAULT 0,
  `numCancelledReservations` INT NOT NULL DEFAULT 0,
...
CREATE TABLE `scheduleSwift`.`nonReservables` (
  `ID` INT NOT NULL AUTO_INCREMENT,
  `businessName` VARCHAR(200) NOT NULL,
  `nonReservable` VARCHAR(200) NULL,
...
CREATE TABLE `permissions` (
  `ID` INT NOT NULL AUTO_INCREMENT,
  `username` VARCHAR(200) NOT NULL,
  `deleteReservations` VARCHAR(200) NOT NULL,
  `editReservations` VARCHAR(200) NOT NULL,
  `viewReservations` VARCHAR(200) NOT NULL,
  PRIMARY KEY (`ID`)
  ) ENGINE=INNODB AUTO_INCREMENT=57 DEFAULT CHARSET=UTF8MB4 COLLATE = UTF8MB4_0900_AI_CI;